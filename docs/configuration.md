...
View this site's [\_config.yml](https://github.com/anwarjaved/tina-cms-test/tree/main/_config.yml) file as an example.

## Site logo

```yaml
# Set a path/url to a logo that will be displayed instead of the title
logo: "/assets/images/tina-cms-test.png"
```
...
footer_content: "Copyright &copy; 2017-2020 Patrick Marsceill. Distributed by an <a href=\"https://github.com/anwarjaved/tina-cms-test/tree/main/LICENSE.txt\">MIT license.</a>"
...
gh_edit_repository: "https://github.com/anwarjaved/tina-cms-test" # the github URL for your repo
...
just_the_docs:
  # Define which collections are used in tina-cms-test
  collections:
